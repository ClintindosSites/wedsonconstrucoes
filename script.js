...
function order() {
  ...
  window.open(
    "https://wa.me/5531988828183?text=Ola,%20quero%20fazer%20um%20orçamento%20sobre um projeto..."
  );
}
function dev() {
...
function insta() {
  ...
  window.open("https://instagram.com/wedsonconstrucoes");
}
function localize() {
  var click = window.document.querySelectorAll("localize");
  window.open(
    "https://www.google.com/maps/dir//Av.+Virg%C3%ADlio+de+Melo+Franco,+479+-+Santa+Amelia,+Belo+Horizonte+-+MG,+31555-120/data=!4m6!4m5!1m1!4e2!1m2!1m1!1s0xa691b5297bfff3:0xc0e50836aebfc1d1?sa=X&ved=1t:707&ictx=111"
  );
}
function stars() {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  prevButtons.forEach(button => {
    button.addEventListener("click", () => {
      const modalSlides = button
        .closest(".modal")
        .querySelector(".modalSlides");
